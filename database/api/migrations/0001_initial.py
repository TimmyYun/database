    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.OneToOneField(blank=True, db_column='id', on_delete=django.db.models.deletion.CASCADE, to='api.diseasetype')),
        ...
        migrations.CreateModel(
            name='Discover',
            fields=[
                ('cname', models.OneToOneField(blank=True, db_column='cname', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.country')),
        ...
        migrations.CreateModel(
            name='Record',
            fields=[
                ('email', models.OneToOneField(blank=True, db_column='email', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.publicservant')),
